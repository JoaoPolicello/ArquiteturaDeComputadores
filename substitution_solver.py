    ...
    def decode_binary_substitution_cipher(self, max_restarts, max_iterations, scores_csv_path=None, save_every=10):
        ...
        for restart in range(max_restarts):
            ...
            while iterations_without_improvement < max_iterations:
                ...
                iteration_count += 1
                # Salva o score a cada N iterações
...
if __name__ == "__main__":
    max_iterations = 100
    max_restarts = 200
    scores_csv_path = "scores_evolucao.csv"  # arquivo que será criado
    ...
    solver.decode_binary_substitution_cipher(max_restarts, max_iterations, scores_csv_path=scores_csv_path, save_every=10)
    print(f"Arquivo de evolução dos scores salvo em: {scores_csv_path}")